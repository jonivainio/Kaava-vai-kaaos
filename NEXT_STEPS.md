...
**Julkaistu julkiseksi 9.9.2026, Sites-versio 5.** Käyttäjä hyväksyi Sites-lähdevarastoon siirron nimenomaisesti, ja aiemmin estynyt lähdepush onnistui. Julkaistu lähdecommit `6c480fd6aa17b0afe2a683216cfc6e0343267862`. Sama peliosoite: https://kaava-vai-kaaos.joni-vainio.chatgpt.site — kirjautumista ei tarvita. Version ja julkaisun tarkat tunnisteet: `reports/pacing/release.json`.

Julkaisuarkisto `.deploy/kaava-pacing-final.tar.gz`, SHA-256 `0433aac441a9b2117c45b98909e0a0a1d0ee1aed211d8f023c69415de1edcd2c`; tarkistettu moottoribundle `98877d3f7811604e14e565c7e15ed04c30834f264eb190d8125fc689b16bfc39`. Julkinen tarkistus `node tools/check-public-v5.mjs reports/pacing` läpäisi: HTTP 200, uusi evästeetön Chromium-konteksti ilman auth-/ohitustunnuksia, palvelimen JS vastaa paikallista buildia, sääntöversio `v5-rules-2`. Siemen `v5-ui-win-2`: 22 päätöstä, 3 vaihesiirtymää ja uudelleenlatausta, 743 pistettä, ei selainvirheitä; jokainen tila vastasi puhdasta moottoria. Raportti `reports/pacing/public-check.json`, kuvat `reports/pacing/public/`. Fyysinen puhelin jää käyttäjän kokeiltavaksi.
